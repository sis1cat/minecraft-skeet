...
public class AbstractUniform {
    ...
    public void setMat2x4(
        float pM00, float pM01, float pM02, float pM03, float pM10, float pM11, float pM12, float pM13
    ) {
    }
    ...
    public void setMat3x3(
        float pM00, float pM01, float pM02, float pM10, float pM11, float pM12, float pM20, float pM21, float pM22
    ) {
    }
