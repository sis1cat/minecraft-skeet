...
public enum IconSet {
    ...
    private IconSet(final String... pPath) {
        this.path = pPath;
    }

    public List<IoSupplier<InputStream>> getStandardIcons(PackResources pResources) throws IOException {
        return List.of(
            this.getFile(pResources, "icon_16x16.png"),
            this.getFile(pResources, "icon_32x32.png"),
            this.getFile(pResources, "icon_48x48.png"),
            this.getFile(pResources, "icon_128x128.png"),
            this.getFile(pResources, "icon_256x256.png")
        );
    }
