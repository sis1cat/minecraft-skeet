    ...
    private void drawElements(int x, int y, Vec2 gameWindowSize){
        ...
        for(Widget widget : elements){
            ...
            if(widget instanceof BindText bindText) {
                ...
                if(link != null){
                    ...
                    if (
                        ...
                        bindText.draw(elementX, elementY);
            ...
            if(widget instanceof Slider slider) {
                ...
                if(link != null){
                    ...
                    if(slider.stringLink != null && link instanceof FunctionSetting functionSetting) {
                        ...
                        slider.draw(elementX, elementY, groupWidth);
            ...
            if(widget instanceof Selectable selectable) {
                ...
                selectable.draw(elementX, elementY, groupWidth);
            ...
            if(widget instanceof Combo combo) {
                ...
                if(link != null){
                    ...
                    if (
                        ...
                        combo.draw(elementX, elementY, groupWidth);
            ...
            if(widget instanceof Button button) {
                ...
                button.draw(elementX, elementY, groupWidth);
        ...
        for(Widget widget : elements) {
            ...
            if (
                ...
                if(bindText.link != null){
                    ...
                    if(
                        ...
                        bindText.color.draw(bindText.x, bindText.y, x, groupWidth);
                        Render.drawAll();
                    } else
            ...
            if (
                ...
                check.color.draw(check.x, check.y, x, groupWidth);
                Render.drawAll();
                RenderSystem.disableScissor();
