...
public record ArgumentSignatures(List<ArgumentSignatures.Entry> entries) {
    ...
    public ArgumentSignatures(FriendlyByteBuf pBuffer) {
        this(pBuffer.<Entry, List<Entry>>readCollection(FriendlyByteBuf.limitValue(ArrayList::new, 8), ArgumentSignatures.Entry::new));
    }

    public void write(FriendlyByteBuf pBuffer) {
        pBuffer.writeCollection(this.entries, (p_241214_, p_241215_) -> p_241215_.write(p_241214_));
    }
