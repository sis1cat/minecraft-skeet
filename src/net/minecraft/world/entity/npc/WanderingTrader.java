        ...
        this.goalSelector
            .addGoal(
                ...
                new UseItemGoal<>(
                    ...
                    p_375164_ -> this.level().isNight() && !p_375164_.isInvisible()
                )
            );
        this.goalSelector
            .addGoal(
                0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, p_375165_ -> this.level().isDay() && p_375165_.isInvisible())
            );
