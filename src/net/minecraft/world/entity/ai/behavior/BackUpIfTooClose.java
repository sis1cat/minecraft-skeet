...
public class BackUpIfTooClose {
    public static OneShot<Mob> create(int pTooCloseDistance, float pStrafeSpeed) {
            ...
            p_260278_ -> p_260278_.group(
                    ...
                    .apply(
                        ...
                        (p_260206_, p_259953_, p_259993_, p_259209_) -> (p_259617_, p_260038_, p_259374_) -> {
                                ...
                                if (livingentity.closerThan(p_260038_, (double)pTooCloseDistance)
                                    ...
                                    p_260038_.getMoveControl().strafe(-pStrafeSpeed, 0.0F);
