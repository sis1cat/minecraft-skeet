...
public class SetEntityLookTargetSometimes {
    ...
    public static BehaviorControl<LivingEntity> create(EntityType<?> pEntityType, float pMaxDist, UniformInt pInterval) {
        return create(pMaxDist, pInterval, p_359036_ -> pEntityType.equals(p_359036_.getType()));
    }
                    ...
                    .apply(
                        ...
                        (p_259350_, p_260134_) -> (p_264952_, p_264953_, p_264954_) -> {
                                Optional<LivingEntity> optional = p_259288_.<NearestVisibleLivingEntities>get(p_260134_)
                                    .findClosest(pCanLookAtTarget.and(p_326890_ -> p_326890_.distanceToSqr(p_264953_) <= (double)f));
                                if (optional.isEmpty()) {
                                    return false;
