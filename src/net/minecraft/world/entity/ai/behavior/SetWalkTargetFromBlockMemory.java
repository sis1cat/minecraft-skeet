    ...
    public static OneShot<Villager> create(MemoryModuleType<GlobalPos> pBlockTargetMemory, float pSpeedModifier, int pCloseEnoughDist, int pTooFarDistance, int pTooLongUnreachableDuration) {
        return BehaviorBuilder.create(
            p_258717_ -> p_258717_.group(
                        p_258717_.registered(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE), p_258717_.absent(MemoryModuleType.WALK_TARGET), p_258717_.present(pBlockTargetMemory)
                    )
                    .apply(
                        p_258717_,
                        (p_258709_, p_258710_, p_258711_) -> (p_275056_, p_275057_, p_275058_) -> {
                                ...
                                if (globalpos.dimension() == p_275056_.dimension()
                                    && (!optional.isPresent() || p_275056_.getGameTime() - optional.get() <= (long)pTooLongUnreachableDuration)) {
