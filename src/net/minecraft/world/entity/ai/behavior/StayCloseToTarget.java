...
public class StayCloseToTarget {
    public static BehaviorControl<LivingEntity> create(
        Function<LivingEntity, Optional<PositionTracker>> pTargetPositionGetter, Predicate<LivingEntity> pPredicate, int pCloseEnoughDist, int pTooClose, float pSpeedModifier
    ) {
