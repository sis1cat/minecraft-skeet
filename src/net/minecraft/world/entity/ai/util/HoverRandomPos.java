...
public class HoverRandomPos {
    ...
    public static Vec3 getPos(
        PathfinderMob pMob, int pRadius, int pYRange, double pX, double pZ, float pAmplifier, int pMaxSwimUp, int pMinSwimUp
    ) {
                ...
                if (blockpos == null) {
                    ...
                    if (blockpos1 == null) {
                        ...
                        blockpos1 = RandomPos.moveUpToAboveSolid(
                            blockpos1,
                            pMob.getRandom().nextInt(pMaxSwimUp - pMinSwimUp + 1) + pMinSwimUp,
                            pMob.level().getMaxY(),
                            p_148486_ -> GoalUtils.isSolid(pMob, p_148486_)
                        );
