...
public abstract class Raider extends PatrollingMonster {
    ...
    static final Predicate<ItemEntity> ALLOWED_ITEMS = p_375184_ -> !p_375184_.hasPickUpDelay()
            && p_375184_.isAlive()
            && ItemStack.matches(p_375184_.getItem(), Raid.getOminousBannerInstance(p_375184_.registryAccess().lookupOrThrow(Registries.BANNER_PATTERN)));
    @Nullable
    protected Raid raid;
    private int wave;
