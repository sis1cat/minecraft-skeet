...
public class GoatAi {
    ...
    private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
        .selector(
            (p_359213_, p_359214_) -> !p_359213_.getType().equals(EntityType.GOAT)
                    && (!p_359214_.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) || !p_359213_.getType().equals(EntityType.ARMOR_STAND))
                    && p_359214_.getWorldBorder().isWithinBounds(p_359213_.getBoundingBox())
        );
            ...
            ImmutableList.of(
                Pair.of(
                    ...
                    new RamTarget(
                        ...
                        3.0F,
                        p_359212_ -> p_359212_.isBaby() ? 1.0 : 2.5,
