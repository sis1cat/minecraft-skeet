...
public class Tadpole extends AbstractFish {
    ...
    private void ageUp() {
        if (this.level() instanceof ServerLevel serverlevel) {
            this.convertTo(EntityType.FROG, ConversionParams.single(this, false, false), p_375120_ -> {
                p_375120_.finalizeSpawn(serverlevel, this.level().getCurrentDifficultyAt(p_375120_.blockPosition()), EntitySpawnReason.CONVERSION, null);
                p_375120_.setPersistenceRequired();
                p_375120_.fudgePositionAfterSizeChange(this.getDimensions(this.getPose()));
