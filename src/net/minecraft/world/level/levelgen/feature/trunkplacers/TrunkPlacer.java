...
public abstract class TrunkPlacer {
    ...
    private static boolean isDirt(LevelSimulatedReader pLevel, BlockPos pPos) {
        return pLevel.isStateAtPosition(pPos, p_70304_ -> Feature.isDirt(p_70304_) && !p_70304_.is(Blocks.GRASS_BLOCK) && !p_70304_.is(Blocks.MYCELIUM));
    }
    ...
    public boolean isFree(LevelSimulatedReader pLevel, BlockPos pPos) {
        return this.validTreePos(pLevel, pPos) || pLevel.isStateAtPosition(pPos, p_226183_ -> p_226183_.is(BlockTags.LOGS));
    }
}