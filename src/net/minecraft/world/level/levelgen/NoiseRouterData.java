...
public class NoiseRouterData {
    ...
    private static DensityFunction spaghetti2D(HolderGetter<DensityFunction> pDensityFunctionRegistry, HolderGetter<NormalNoise.NoiseParameters> pNoiseParameters) {
        ...
        DensityFunction densityfunction2 = DensityFunctions.mappedNoise(pNoiseParameters.getOrThrow(Noises.SPAGHETTI_2D_ELEVATION), 0.0, (double)Math.floorDiv(-64, 8), 8.0);
    ...
    private static DensityFunction yLimitedInterpolatable(DensityFunction pInput, DensityFunction pWhenInRange, int pMinY, int pMaxY, int pWhenOutOfRange) {
        return DensityFunctions.interpolated(
            DensityFunctions.rangeChoice(pInput, (double)pMinY, (double)(pMaxY + 1), pWhenInRange, DensityFunctions.constant((double)pWhenOutOfRange))
        );
    }
