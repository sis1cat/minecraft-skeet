...
public interface PosRuleTestType<P extends PosRuleTest> {
    ...
    static <P extends PosRuleTest> PosRuleTestType<P> register(String pName, MapCodec<P> pCodec) {
        return Registry.register(BuiltInRegistries.POS_RULE_TEST, pName, () -> pCodec);
    }
}