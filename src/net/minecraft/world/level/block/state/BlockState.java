...
public class BlockState extends BlockBehaviour.BlockStateBase implements IForgeBlockState {
    ...
    public void initCache() {
        super.initCache();
        this.cache = (BlockBehaviour.BlockStateBase.Cache)Reflector.BlockBehaviour_BlockStateBase_cache.getValue(this);
    }
    ...
    public static Class getBlockStateBaseCacheClass() {
        return BlockBehaviour.BlockStateBase.Cache.class;
    }
