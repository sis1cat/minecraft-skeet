...
public class BuiltInLootTables {
    ...
    public static final Map<DyeColor, ResourceKey<LootTable>> SHEEP_BY_DYE = Util.make(
        new EnumMap<>(DyeColor.class), p_367364_ -> makeDyeKeyMap((EnumMap<DyeColor, ResourceKey<LootTable>>)p_367364_, "entities/sheep")
    );
    ...
    public static final Map<DyeColor, ResourceKey<LootTable>> SHEAR_SHEEP_BY_DYE = Util.make(
        new EnumMap<>(DyeColor.class), p_363454_ -> makeDyeKeyMap((EnumMap<DyeColor, ResourceKey<LootTable>>)p_363454_, "shearing/sheep")
    );
