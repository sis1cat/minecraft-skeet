...
public class WorldBorderCommand {
                        ...
                        .then(
                            Commands.argument("distance", DoubleArgumentType.doubleArg(-5.999997E7F, 5.999997E7F))
                                .executes(
                                    p_358654_ -> setSize(
                                            p_358654_.getSource(),
                                            p_358654_.getSource().getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(p_358654_, "distance"),
                                            0L
                                        )
                                )
                                .then(
                                    Commands.argument("time", IntegerArgumentType.integer(0))
                                        .executes(
                                            p_358655_ -> setSize(
                                                    p_358655_.getSource(),
                                                    p_358655_.getSource().getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(p_358655_, "distance"),
                                                    p_358655_.getSource().getLevel().getWorldBorder().getLerpRemainingTime()
                                                        + (long)IntegerArgumentType.getInteger(p_358655_, "time") * 1000L
                                                )
                                        )
                                )
                        )
    ...
    private static int setCenter(CommandSourceStack pSource, Vec2 pPos) throws CommandSyntaxException {
        ...
        } else if (!((double)Math.abs(pPos.x) > 2.9999984E7) && !((double)Math.abs(pPos.y) > 2.9999984E7)) {
