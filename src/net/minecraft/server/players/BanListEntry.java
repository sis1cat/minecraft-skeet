...
public abstract class BanListEntry<T> extends StoredUserEntry<T> {
    ...
    public BanListEntry(@Nullable T pUser, @Nullable Date pCreated, @Nullable String pSource, @Nullable Date pExpires, @Nullable String pReason) {
        super(pUser);
    ...
    protected BanListEntry(@Nullable T pUser, JsonObject pEntryData) {
        super(pUser);
