...
public record FilteredText(String raw, FilterMask mask) {
    ...
    public static FilteredText passThrough(String pRaw) {
        return new FilteredText(pRaw, FilterMask.PASS_THROUGH);
    }

    public static FilteredText fullyFiltered(String pRaw) {
        return new FilteredText(pRaw, FilterMask.FULLY_FILTERED);
    }
