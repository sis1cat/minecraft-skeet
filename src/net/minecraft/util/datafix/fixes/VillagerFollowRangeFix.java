...
public class VillagerFollowRangeFix extends NamedEntityFix {
    ...
    public VillagerFollowRangeFix(Schema pOutputSchema) {
        super(pOutputSchema, false, "Villager Follow Range Fix", References.ENTITY, "minecraft:villager");
    }
