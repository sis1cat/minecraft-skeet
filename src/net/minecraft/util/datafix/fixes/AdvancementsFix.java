...
public class AdvancementsFix extends AdvancementsRenameFix {
    ...
    public AdvancementsFix(Schema pOutputSchema, boolean pChangesType) {
        super(pOutputSchema, pChangesType, "AdvancementsFix", p_14648_ -> RENAMES.getOrDefault(p_14648_, p_14648_));
    }
}