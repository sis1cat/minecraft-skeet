...
public interface FormattedCharSequence {
    ...
    static FormattedCharSequence codepoint(int pCodePoint, Style pStyle) {
        return p_13730_ -> p_13730_.accept(0, pStyle, pCodePoint);
    }

    static FormattedCharSequence forward(String pText, Style pStyle) {
        return pText.isEmpty() ? EMPTY : p_13739_ -> StringDecomposer.iterate(pText, pStyle, p_13739_);
    }

    static FormattedCharSequence forward(String pText, Style pStyle, Int2IntFunction pCodePointMapper) {
        return pText.isEmpty() ? EMPTY : p_144730_ -> StringDecomposer.iterate(pText, pStyle, decorateOutput(p_144730_, pCodePointMapper));
    }

    static FormattedCharSequence backward(String pText, Style pStyle) {
        return pText.isEmpty() ? EMPTY : p_144716_ -> StringDecomposer.iterateBackwards(pText, pStyle, p_144716_);
    }

    static FormattedCharSequence backward(String pText, Style pStyle, Int2IntFunction pCodePointMapper) {
        return pText.isEmpty() ? EMPTY : p_13721_ -> StringDecomposer.iterateBackwards(pText, pStyle, decorateOutput(p_13721_, pCodePointMapper));
    }

    static FormattedCharSink decorateOutput(FormattedCharSink pSink, Int2IntFunction pCodePointMapper) {
        return (p_13711_, p_13712_, p_13713_) -> pSink.accept(p_13711_, p_13712_, pCodePointMapper.apply(Integer.valueOf(p_13713_)));
    }
    ...
    static FormattedCharSequence fromPair(FormattedCharSequence pFirst, FormattedCharSequence pSecond) {
        return p_13702_ -> pFirst.accept(p_13702_) && pSecond.accept(p_13702_);
    }
