...
public class VanillaItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider p_255639_) {
        ...
        p_255639_.lookupOrThrow(Registries.TRIM_MATERIAL)
            .listElements()
            .sorted(Comparator.comparing(p_378276_ -> p_378276_.key().location()))
            .forEach(p_377193_ -> this.tag(ItemTags.TRIM_MATERIALS).add(p_377193_.value().ingredient().value()));
