...
public class BakedQuad {
    ...
    public BakedQuad(
        int[] vertexDataIn, int tintIndexIn, Direction faceIn, TextureAtlasSprite spriteIn, boolean shadeIn, int lightEmissionIn, boolean hasAmbientOcclusion
    ) {
        this(vertexDataIn, tintIndexIn, faceIn, spriteIn, shadeIn, lightEmissionIn);
    ...
    public Direction getDirection() {
        if (this.direction == null) {
            this.direction = FaceBakery.calculateFacing(this.getVertices());
        }
