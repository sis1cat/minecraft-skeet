...
public class ItemStackRenderState {
    ...
    public class LayerRenderState {
        ...
        public ItemStackRenderState.FoilType foilType = ItemStackRenderState.FoilType.NONE;
        public int[] tintLayers = new int[0];
        @Nullable
        public SpecialModelRenderer<Object> specialRenderer;
        @Nullable
        public Object argumentForSpecialRendering;
        private ItemStack itemStack;
        public BakedModel renderModel;
