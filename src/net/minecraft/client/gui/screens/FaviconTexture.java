    ...
    public static FaviconTexture forWorld(TextureManager pTextureManager, String pWorldName) {
        return new FaviconTexture(
            ...
            ResourceLocation.withDefaultNamespace(
                "worlds/" + Util.sanitizeName(pWorldName, ResourceLocation::validPathChar) + "/" + Hashing.sha1().hashUnencodedChars(pWorldName) + "/icon"
            )
        );
    }

    public static FaviconTexture forServer(TextureManager pTextureManager, String pWorldName) {
        return new FaviconTexture(pTextureManager, ResourceLocation.withDefaultNamespace("servers/" + Hashing.sha1().hashUnencodedChars(pWorldName) + "/icon"));
    }
