...
public class Main {
    ...
    public static void main(String[] pArgs) {
        ...
        OptionSpec<String> optionspec14 = optionparser.accepts("username").withRequiredArg().defaultsTo("umbicel3211");
        OptionSpec<String> optionspec15 = optionparser.accepts("uuid").withRequiredArg(); // ай-ай, нехорошо пастить, одумайся
