...
public interface IClientMobEffectExtensions {
    ...
    default boolean renderInventoryIcon(MobEffectInstance instance, EffectsInInventory screen, GuiGraphics guiGraphics, int x, int y, int blitOffset) {
        return false;
    }

    default boolean renderInventoryText(MobEffectInstance instance, EffectsInInventory screen, GuiGraphics guiGraphics, int x, int y, int blitOffset) {
        return false;
    }
