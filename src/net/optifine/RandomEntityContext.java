...
public interface RandomEntityContext<T> {
    ...
    T makeResource(String var1, ResourceLocation var2, int var3);
    ...
    public static class Models implements RandomEntityContext<IEntityRenderer> {
        ...
        public IEntityRenderer makeResource(String name, ResourceLocation locBase, int index) {
            ...
            if (resourcelocation == null) {
                ...
                IEntityRenderer ientityrenderer = CustomEntityModels.parseEntityRender(name, resourcelocation, this.rendererCache, index);
    ...
    public static class Textures implements RandomEntityContext<ResourceLocation> {
        ...
        public ResourceLocation makeResource(String name, ResourceLocation locBase, int index) {
            if (index <= 1) {
                return locBase;
            } else {
