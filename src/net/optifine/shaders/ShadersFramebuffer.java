...
public class ShadersFramebuffer {
    ...
    public void setup() {
        ...
        for (int l = 0; l < this.usedColorBuffers; l++) {
            ...
            Dimension dimension = this.colorBufferSizes[l] != null
                ? this.colorBufferSizes[l].getDimension(this.width, this.height)
                : new Dimension(this.width, this.height);
            GL30.glTexImage2D(
                3553, 0, this.buffersFormat[l], dimension.width, dimension.height, 0, Shaders.getPixelFormat(this.buffersFormat[l]), 33639, (ByteBuffer)null
            );
        ...
        for (int i1 = 0; i1 < this.usedColorBuffers; i1++) {
            ...
            Dimension dimension1 = this.colorBufferSizes[i1] != null
                ? this.colorBufferSizes[i1].getDimension(this.width, this.height)
                : new Dimension(this.width, this.height);
            GL30.glTexImage2D(
                3553,
                0,
                this.buffersFormat[i1],
                dimension1.width,
                dimension1.height,
                0,
                Shaders.getPixelFormat(this.buffersFormat[i1]),
                33639,
                (ByteBuffer)null
            );
