...
public class SVertexBuilder {
    ...
    private long[] entityData = new long[10];
    ...
    public static void pushEntity(BlockState blockState, VertexConsumer ivb) {
        if (ivb instanceof BufferBuilder bufferbuilder) {
    ...
    public static void endSetVertexFormat(BufferBuilder wrr) {
        ...
        svertexbuilder.vertexFormat = vertexformat;
    ...
    public static void endAddVertexData(BufferBuilder wrr, int vertexCount) {
        SVertexBuilder svertexbuilder = wrr.sVertexBuilder;
        if (svertexbuilder.vertexSize == 18 && wrr.getDrawMode() == VertexFormat.Mode.QUADS && wrr.getVertexCount() % 4 == 0) {
            endSetVertexFormat(wrr);
            int i = vertexCount * svertexbuilder.vertexSize;
    ...
    public static boolean preDrawArrays(VertexFormat vf) {
        ...
        if (i != 72) {
            ...
            GL20.glVertexAttribPointer(Shaders.midTexCoordAttrib, 2, 5126, false, i, 36L);
            GL20.glVertexAttribPointer(Shaders.tangentAttrib, 4, 5122, false, i, 44L);
            GL20.glVertexAttribPointer(Shaders.entityAttrib, 3, 5122, false, i, 52L);
            GL20.glVertexAttribPointer(Shaders.velocityAttrib, 3, 5126, false, i, 60L);
