...
public class GuiSliderShaderOption extends GuiButtonShaderOption {
    ...
    public void renderWidget(GuiGraphics graphicsIn, int mouseX, int mouseY, float partialTicks) {
        if (this.visible) {
            ...
            graphicsIn.blitSprite(RenderType::guiTextured, this.getSprite(), this.getX(), this.getY(), this.getWidth(), this.getHeight());
            graphicsIn.blitSprite(
                RenderType::guiTextured,
                this.getHandleSprite(),
                this.getX() + (int)(this.sliderValue * (float)(this.width - 8)),
                this.getY(),
                8,
                this.getHeight()
            );
