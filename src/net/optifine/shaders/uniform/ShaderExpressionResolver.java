...
public class ShaderExpressionResolver implements IExpressionResolver {
    ...
    private void registerExpressions() {
        ...
        BiomeCategory[] abiomecategory = BiomeCategory.values();

        for (int l = 0; l < abiomecategory.length; l++) {
            BiomeCategory biomecategory = abiomecategory[l];
            String s1 = "CAT_" + biomecategory.getName().toUpperCase();
        ...
        for (int i1 = 0; i1 < abiome$precipitation.length; i1++) {
            ...
            String s2 = "PPT_" + biome$precipitation.name().toUpperCase();
